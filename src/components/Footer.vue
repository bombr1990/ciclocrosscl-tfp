  ...
  <footer class="bg-gray-900 text-white mt-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <!-- Información -->
        <div>
          <h3 class="text-lg font-bold mb-4">Ciclocross Chile</h3>
          <p class="text-gray-400 text-sm">
            Portal oficial del ciclocross en Chile. Resultados, noticias y toda la información sobre
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li>
              <router-link to="/" class="text-gray-400 hover:text-secondary-300 transition-colors">
                Inicio
              </router-link>
            </li>
            <li>
        ...
        <div>
          ...
          <div class="flex space-x-4">
            <a href="#" class="text-gray-400 hover:text-secondary-300 transition-colors">
